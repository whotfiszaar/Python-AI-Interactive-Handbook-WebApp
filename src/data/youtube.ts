...
export const youtubeVideos: YouTubeVideo[] = [
  ...
  },
  {
    id: "api-fireship",
    videoId: "ScKCy2udln8",
    title: "What is an API? (in 100 seconds)",
    channel: "Fireship",
    durationLabel: "~3min",
  ...
  {
    id: "json-mode-indently",
    videoId: "2FqXBlzTkw0",
    title: "How To Use OpenAI JSON Mode and Structured Outputs",
    channel: "Indently",
    durationLabel: "~15min",
    topicRange: "Topics 29-30: Project 1 AI Chatbot and Working with JSON Responses",
    dayRange: "Days 29-30",
    days: [29, 30],
    why: "Shows how to ask an LLM to return valid JSON and parse it safely with try/except. Critical for building reliable AI apps that need structured data.",
    topics: ["JSON", "structured output", "json.loads", "error handling", "chatbot"],
  },
  {
  ...
  {
    id: "langchain-app-alejandro",
    videoId: "aywZrzNaKjs",
    title: "Build a LangChain App in 10 Minutes",
    channel: "Alejandro AO",
    durationLabel: "~15min",
    topicRange: "Topic 35: Project 2 - AI Story Generator",
    dayRange: "Day 35",
    days: [35],
    why: "A fast, hands-on build of a LangChain app with memory and prompts. The perfect template for your story generator project.",
    topics: ["LangChain", "project", "story generator", "memory", "app"],
  },
  {
    id: "mcp-anthropic",
    videoId: "yzwmTeA4Dgw",
